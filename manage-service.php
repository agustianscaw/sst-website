            ...
            <nav class="navbar navbar-default">
              ...
              <div class="collapse navbar-collapse main-menu bs-example-navbar-collapse-1" id="navbar-example">
                <ul class="nav navbar-nav navbar-right">
                  ...
                  <li>
                    <a class="page-scroll" href="manage-user">User</a>
                  </li>
                </ul>
              </div>
              <!-- navbar-collapse -->
          ...
          <div class="slider-content text-center">
            <div class="header-bottom">
              ...
              <div class="layer3 wow zoomInUp" data-wow-duration="2s" data-wow-delay="1s">
                <h2 class="title3">Management Service Surya Sari Teknik</h2>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <tr>
            <td>Nama Service</td>
            <td><input type="text" name="namaService" id="namaService"/></td>
          </tr>
          <tr>
        ...
        <tr>
            <td>Product</td>
            <td><?php echo "<select id='product_idproduct' name='product_idproduct'>";   
                $mysqli= new mysqli("localhost","root","","mydb");
 	              $sql="select * from product order by namaProduct ASC";
 	              $result=$mysqli->query($sql);
 	              if ($result->num_rows){
 	                while ($row=$result->fetch_object()) {
 	                    echo "<option value='$row->idproduct'>$row->namaProduct</option> ";
 	                }
                }?>
            </td>
        </tr>
        <tr>
            <td>Vendor</td>
            <td><?php echo"<select id='product_idvendor' name='product_idvendor'>";    
                $mysqli= new mysqli("localhost","root","","mydb");
...
$(document).ready(function(){
 ...
 $(document).on('click', '.update', function(){
  ...
  $.ajax({
      url:"service-config.php",
      method:"POST",
      data:{idservice:idservice,action:action},
      dataType:"json",
      success:function(data){
          $('#imageModal').modal('show');
          $('#namaService').val(data.namaService);
          $('#deskripsi').val(data.deskripsi);
          $('#product_idvendor').val(data.product_idvendor);
          $('#product_idproduct').val(data.product_idproduct);
 ...
 $(document).on('click', '.delete', function(){
  var idservice = $(this).attr("id");
  var action = "delete";
  if(confirm("Are you sure you want to remove this Service from database?"))
  {
   $.ajax({
    url:"service-config.php",
    method:"POST",
